...
// first g-tag for x axis text
svg.append("g").attr("class", "xText");
var xText = d3.select(".xText");

// Transform to accommodate xText
...
// Read in data from  CSV file with health and population information
   ...
   var toolTip = d3.tip()
    ...
    function xMinMax() {
      ...
      xMax = d3.max(csvData, function(d) {
        return parseFloat(d[currentX]) * 1.20;
      });     
    }
    ...
    function yMinMax() {
      ...
      yMax = d3.max(csvData, function(d) {
        return parseFloat(d[currentY]) * 1.20;
      }); 
    }
